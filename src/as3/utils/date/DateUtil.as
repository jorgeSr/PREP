package as3.utils.date
{
	...
	public class DateUtil
	{
		/**
		 *      
		 * Get the date with as String, problems with serialization php ZendAMF          
		 *
		 * 
		 */ 	
		public static function getDateAsString(d:Date):String
		{
		...
		/**
		 *      
		 * Get the String date with as Date, problems with serialization php ZendAMF          
		 *
		 * 
		 */ 	
		public static function getStringAsDate(s:String, separador:String = "-"):Date
		{
			var d:Date = new Date();
			d.fullYear = int( s.substr(0, s.indexOf( separador ) ) );
			s = s.substring(s.indexOf( separador )+1);
			
			d.month = int( s.substr(0, s.indexOf( separador ) ) );
			s = s.substring(s.indexOf( separador )+1);
		...
		/**
		 *      
		 * Get the String date with as String view, problems with serialization php ZendAMF          
		 *
		 * 
		 */ 
		public static function getStringdateAsStringdateview(s:String, separador:String = "-"):String
		{
			var sv:String = "";
			sv = s.substr(0, s.indexOf( separador ) );
			s = s.substring(s.indexOf( separador )+1);
			
			sv = (int(s.substr(0, s.indexOf( separador ) ))+1)+"/"+sv;
			s = s.substring(s.indexOf( separador )+1);
		...
		/**
		 *      
		 * Get the date with as String view, problems with serialization php ZendAMF          
		 *
		 * 
		 */ 
		public static function getDateAsStringdateview(d:Date, separador:String = "-"):String			
		{
			return d.date+"/"+(d.month+1)+"/"+d.fullYear;
		}
